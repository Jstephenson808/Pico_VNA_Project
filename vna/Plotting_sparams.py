...
from VNA_enums import TwoPortSParams, DataFrameCols
...
data.single_freq_plotter(ghz_to_hz(1.0), plot_s_param=TwoPortSParams.S11, data_frame_column_to_plot=DataFrameCols.MAGNITUDE)
