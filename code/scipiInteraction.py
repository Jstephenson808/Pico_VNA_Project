...
for gesture in test_gestures:
    ...
    for test in range(n_tests):
        ...
        while current_time < finish_time:
            ...
            SNA.write(save_snp_command_string(f"{current_test_foler}/capture_{i}"))
            current_time = datetime.now()
            i += 1
